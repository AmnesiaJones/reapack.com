...
- Add support for REAPER v7.40's new Crossfade Editor action section
- Add support for installing files in the KeyMaps folder
- Update filter synonym list to REAPER v7.44's
- Don't focus the package list when pressing up/down on the browser's display combo
